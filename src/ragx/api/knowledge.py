...
from ragx.services.knowledge import create_knowledge_base, delete_knowledge_base, get_knowledge_base, list_knowledge_bases
...
async def create_kb(
      ...
      kb = await create_knowledge_base(
          session, ctx, name=body.name, description=body.description
      )
